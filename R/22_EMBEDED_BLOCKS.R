#' Embeded blocks regression
#'
#' \code{embeded.blocks} performs blockwise regression where the predictions of each blocks' model is used as an 
...
#'blocks
#'#method: stepFWD
#'res <- embeded.blocks(method = "stepFWD", 
...
#'@export
embeded.blocks <- function(method, target, db, coding = "WoE", blocks, 
