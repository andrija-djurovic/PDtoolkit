...
outmost importance for analysts. The main goal of this package is to
...
option to perform cluster analysis and shorthen the list of potential
...
rating grade level (binomial, Jeffreys, z-score), while one refers to
the complete rating scale (Hosmer-Lemeshow test).
