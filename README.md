...
```
    ...
    ## Loading required package: monobin
...
```
    ...
    ## 9 Foreign Worker         1 [2,1] 1000 700 300 1.000 1.0000000 1.00000000 0.3000000 1000 700 300
    ...
    ## 9 1.0000000 1.00000000  0.00000000 0.0000000000 0.0000000        NA
    ## 
    ## $info
    ## data frame with 0 columns and 0 rows
