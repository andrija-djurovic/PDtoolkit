...
```
    ...
    ##                                   rf   rf.type       bin.type            bin  cnt   pct cnt.unique
    ## 1                      Creditability   numeric complete cases complete cases 1000 1.000          2
    ## 2                    Account Balance character complete cases complete cases 1000 1.000          4
    ## 3         Duration of Credit (month)   numeric complete cases complete cases 1000 1.000         33
    ## 4  Payment Status of Previous Credit character complete cases complete cases 1000 1.000          5
    ## 5                            Purpose character  special cases  special cases   21 0.021          1
    ## 6                            Purpose character complete cases complete cases  979 0.979         10
    ## 7                      Credit Amount   numeric  special cases  special cases   10 0.010          1
    ## 8                      Credit Amount   numeric complete cases complete cases  990 0.990        915
    ## 9               Value Savings/Stocks character complete cases complete cases 1000 1.000          5
    ## 10      Length of current employment character complete cases complete cases 1000 1.000          5
    ## 11               Instalment per cent character complete cases complete cases 1000 1.000          4
    ## 12              Sex & Marital Status character complete cases complete cases 1000 1.000          4
    ## 13                        Guarantors character complete cases complete cases 1000 1.000          3
    ## 14       Duration in Current address character complete cases complete cases 1000 1.000          4
    ## 15     Most valuable available asset character complete cases complete cases 1000 1.000          4
    ## 16                       Age (years)   numeric  special cases  special cases   21 0.021          1
    ## 17                       Age (years)   numeric complete cases complete cases  979 0.979         53
    ## 18                Concurrent Credits character complete cases complete cases 1000 1.000          3
    ## 19                 Type of apartment character complete cases complete cases 1000 1.000          3
    ## 20        No of Credits at this Bank character complete cases complete cases 1000 1.000          4
    ## 21                        Occupation character complete cases complete cases 1000 1.000          4
    ## 22                  No of dependents character complete cases complete cases 1000 1.000          2
    ## 23                         Telephone character complete cases complete cases 1000 1.000          2
    ## 24                    Foreign Worker character complete cases complete cases 1000 1.000          2
    ##    min     p1     p5     p25  p50        avg      avg.se     p75    p95      p99   max neg  pos
    ## 1    0   0.00   0.00    0.00    0    0.30000  0.01449863    1.00    1.0     1.00     1   0  300
    ## 2   NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 3    4   6.00   6.00   12.00   18   20.90300  0.38133320   24.00   48.0    60.00    72   0 1000
    ## 4   NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0  960
    ## 5   NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA  NA   NA
    ## 6   NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0  755
    ## 7  Inf     NA     NA      NA   NA        NaN          NA      NA     NA       NA  -Inf  NA   NA
    ## 8  250 424.13 708.45 1371.25 2324 3283.24242 90.03256824 3978.25 9219.7 14194.29 18424   0  990
    ## 9   NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 10  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 11  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 12  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 13  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 14  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 15  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 16 Inf     NA     NA      NA   NA        NaN          NA      NA     NA       NA  -Inf  NA   NA
    ## 17  19  20.00  22.00   27.00   33   35.52605  0.36315861   42.00   60.0    67.22    75   0  979
    ## 18  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 19  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 20  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 21  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 22  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 23  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ## 24  NA     NA     NA      NA   NA         NA          NA      NA     NA       NA    NA   0 1000
    ##    cnt.outliers sc.ind
    ## 1             0      0
    ## 2            NA      0
    ## 3            70      0
...
status which will serve as our dependent variable for PD model
...
```
    ...
    ## 1 -0.02409755     0.2208734           -0.2713578                  -0.47082029         -0.15730029
    ## 2 -0.20500910     0.2208734           -0.2713578                  -0.03210325          0.15546647
    ## 3 -0.20500910     0.2208734           -0.1395519                   0.39441527          0.15546647
    ## 4 -0.20500910     0.2208734           -0.2713578                  -0.03210325          0.06453852
    ## 5 -0.20500910     0.2208734           -0.2713578                  -0.03210325         -0.15730029
    ## 6 -0.20500910     0.2208734           -0.2713578                  -0.47082029          0.25131443
    ##   Sex & Marital Status   Guarantors Duration in Current address Most valuable available asset
    ## 1           -0.2353408 0.0005250722                -0.001152738                   -0.02857337
    ## 2            0.1655476 0.0005250722                -0.070150705                    0.46103496
    ## 3           -0.2353408 0.0005250722                -0.001152738                    0.46103496
    ## 4            0.1655476 0.0005250722                -0.070150705                    0.46103496
    ## 5            0.1655476 0.0005250722                -0.001152738                   -0.02857337
    ## 6            0.1655476 0.0005250722                 0.054941118                    0.46103496
    ##   Age (years) Concurrent Credits Type of apartment No of Credits at this Bank Occupation
    ## 1  -0.5346145          0.1211786        -0.4044452                 -0.0748775 0.02278003
    ## 2   0.3215187          0.1211786        -0.4044452                  0.1157105 0.02278003
    ## 3  -0.5346145          0.1211786        -0.4044452                 -0.0748775 0.09716375
    ## 4   0.3215187          0.1211786        -0.4044452                  0.1157105 0.09716375
    ## 5   0.3215187         -0.4836299         0.1960517                  0.1157105 0.09716375
    ## 6   0.3215187          0.1211786        -0.4044452                  0.1157105 0.09716375
    ##   No of dependents   Telephone
...
```
    ...
    ## 6             0      -0.8180987                  0.3466246                        0.73374058
    ##       Purpose Credit Amount Value Savings/Stocks Length of current employment Instalment per cent
    ## 1 -0.02409755 01 [250,3914)           -0.2713578                            2                   4
    ## 2 -0.20500910 01 [250,3914)           -0.2713578                            3                   2
    ## 3 -0.20500910 01 [250,3914)           -0.1395519                            4                   2
    ## 4 -0.20500910 01 [250,3914)           -0.2713578                            3                   3
    ## 5 -0.20500910 01 [250,3914)           -0.2713578                            3                   4
    ## 6 -0.20500910 01 [250,3914)           -0.2713578                            2                   1
    ##   Sex & Marital Status   Guarantors Duration in Current address Most valuable available asset
    ...
    ##       Age (years) Concurrent Credits Type of apartment No of Credits at this Bank Occupation
    ## 1  1 [01 [19,26)]                  3                 1                          1          3
    ## 2 3 [03 [35,Inf)]                  3                 1                          2          3
    ## 3  1 [01 [19,26)]                  3                 1                          1          2
    ## 4 3 [03 [35,Inf)]                  3                 1                          2          2
    ## 5 3 [03 [35,Inf)]                  1                 2                          2          2
    ## 6 3 [03 [35,Inf)]                  3                 1                          2          2
    ##   No of dependents Telephone
    ## 1                1         1
    ## 2                2         1
    ## 3                1         1
...
observed default rates. That is always one-tail test, but direction
...
page of the function `?homogeneity` from the `PDtoolkit` package.
Closely related validation procedure to heterogeneity and homogeneity is
validation of discriminatory power of the PD model. Namely, analysts
usually have to validate and make sure that discriminatory power of the
PD model is use did not deteriorate significantly from the moment of its
development. In order to test the discriminatory power of the PD model
in use, we will apply `dp.testing` function for the `PDtoolkit` package.
...
```
    ...
    ##         rating  no nb        odr       pdc alpha  binomial   binomial.res   jeffreys   jeffreys.res
    ## 1 01 [417,473)  47 36 0.76595745 0.7400826  0.05 0.4159984 H0: ODR <= PDC 0.35159815 H0: ODR <= PDC
    ## 2 02 [473,482)  35 21 0.60000000 0.6069830  0.05 0.6059111 H0: ODR <= PDC 0.53854844 H0: ODR <= PDC
    ## 3 03 [482,506)  93 37 0.39784946 0.3750350  0.05 0.3613128 H0: ODR <= PDC 0.32231637 H0: ODR <= PDC
    ## 4 04 [506,515)  53 15 0.28301887 0.2516151  0.05 0.3479606 H0: ODR <= PDC 0.29276184 H0: ODR <= PDC
    ## 5 05 [515,547) 131 22 0.16793893 0.1537853  0.05 0.3621511 H0: ODR <= PDC 0.31876653 H0: ODR <= PDC
    ## 6 06 [547,Inf) 141 11 0.07801418 0.0500000  0.05 0.0966087 H0: ODR <= PDC 0.07085215 H0: ODR <= PDC
    ##       zscore     zscore.res hosmer.lemeshow hosmer.lemeshow.res
    ## 1 0.34293973 H0: ODR <= PDC       0.7851538      H0: ODR <= PDC
    ## 2 0.53370338 H0: ODR <= PDC       0.7851538      H0: ODR <= PDC
    ## 3 0.32475205 H0: ODR <= PDC       0.7851538      H0: ODR <= PDC
    ## 4 0.29914802 H0: ODR <= PDC       0.7851538      H0: ODR <= PDC
    ## 5 0.32669329 H0: ODR <= PDC       0.7851538      H0: ODR <= PDC
    ## 6 0.06346722 H0: ODR <= PDC       0.7851538      H0: ODR <= PDC
